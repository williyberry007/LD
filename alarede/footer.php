			...
			<div class="ae-footer__widgets">
				...
				<?php else : ?>
					...
					<div class="ae-footer__col">
						<h3 class="widget-title"><?php esc_html_e( 'Explore', 'alarede' ); ?></h3>
						<?php
						wp_nav_menu(
							array(
					...
					<div class="ae-footer__col">
						<h3 class="widget-title"><?php esc_html_e( 'Get In Touch', 'alarede' ); ?></h3>
						<p><?php echo esc_html( get_theme_mod( 'alarede_contact_email', 'hello@example.com' ) ); ?><br>
						<?php echo esc_html( get_theme_mod( 'alarede_contact_phone', '' ) ); ?></p>
						<p><?php echo wp_kses_post( nl2br( get_theme_mod( 'alarede_contact_address', '' ) ) ); ?></p>
					</div>
				<?php endif; ?>
			</div>
		</div>
			...
			<div class="ae-container">
				...
				if ( $footer_text ) {
					...
					printf(
						...
						esc_html__( '© %1$s %2$s. All rights reserved.', 'alarede' ),
						esc_html( gmdate( 'Y' ) ),
