...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'alarede' ); ?></a>
	...
	<header id="masthead" class="site-header <?php echo esc_attr( $ae_transparent ); ?>" data-transparent="<?php echo esc_attr( $ae_transparent ); ?>">
		<div class="ae-container site-header__inner">
			...
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
				...
				<span class="screen-reader-text"><?php esc_html_e( 'Menu', 'alarede' ); ?></span>
			</button>

			<nav id="site-navigation" class="main-navigation" aria-label="<?php esc_attr_e( 'Primary', 'alarede' ); ?>">
				<?php
				wp_nav_menu(
					array(
						...
						'container'      => false,
						'fallback_cb'    => 'alarede_default_menu',
					)
				);
				?>
			</nav>
 ...
 */
function alarede_default_menu() {
	echo '<ul id="primary-menu">';
	echo '<li><a href="' . esc_url( home_url( '/' ) ) . '">' . esc_html__( 'Home', 'alarede' ) . '</a></li>';
